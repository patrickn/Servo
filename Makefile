...
ARDUINO = ${HOME}/Arduino/Arduino/hardware/arduino/cores/arduino
ARDUINO_LIBS = ${HOME}/Arduino/Arduino/libraries
...
CINCS = -I$(ARDUINO) -I$(ARDUINO_LIBS)/Servo
CXXINCS = -I$(ARDUINO) -I$(ARDUINO_LIBS)/Servo
...
$(TARGET).elf: core.a
	$(CC) $(ALL_CXXFLAGS) -o $@ $(TARGET).cpp -L. core.a $(LDFLAGS)
